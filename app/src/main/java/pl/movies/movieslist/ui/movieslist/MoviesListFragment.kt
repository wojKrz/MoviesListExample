...
class MoviesListFragment : Fragment() {
    ...
    private fun observeListItems() {
        ...
        viewModel
            ...
            .observe(viewLifecycleOwner) {
                val items = it.map(::NowPlayingMovieListItem)
        ...
        viewModel
            .moviesListState
            .observe(viewLifecycleOwner, ::handleNewState)
    }

    private fun handleNewState(state: MoviesListState) {
        when (state) {
            is MoviesListState.SuccessState -> handleSuccessState(state)
            is MoviesListState.ErrorState -> handleErrorState(state)
        }
    }

    private fun handleSuccessState(state: MoviesListState.SuccessState) {
    ...
    private fun handleErrorState(state: MoviesListState.ErrorState) {
